...
- [next/navigation router.refresh mock](feedback_router_refresh_mock.md) — include refresh: vi.fn() alongside push in useRouter mock when component calls router.refresh()
